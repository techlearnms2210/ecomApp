...
docker pull techlearnms2210/new-api-gateway:latest
docker pull techlearnms2210/new-product-service:latest
docker pull techlearnms2210/new-order-service:latest
docker pull techlearnms2210/new-inventory-service:latest
docker pull techlearnms2210/new-notification-service:latest
...
kind load docker-image -n microservices techlearnms2210/new-api-gateway:latest
kind load docker-image -n microservices techlearnms2210/new-product-service:latest
kind load docker-image -n microservices techlearnms2210/new-order-service:latest
kind load docker-image -n microservices techlearnms2210/new-inventory-service:latest
kind load docker-image -n microservices techlearnms2210/new-notification-service:latest